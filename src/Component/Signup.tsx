        ...
        <div>
            ...
            <div className='w-screen h-screen items-center justify-center flex flex-col'>
                <div className='xl:w-[50%] w-[80%] flex flex-col gap-10'>
                    ...
                    <button disabled={loading} className='h-[8vh] outline-0 hover:bg-black  hover:text-white rounded-[10px] font-bold tracking-[1px] transition ease-in duration-400   text-[1.2rem] mt-2  bg-transparent border-2 border-black text-black' onClick={handleRegister}>{loading ? 'loading...' : 'SignUp'}</button>
                </div>
